            ...
            <div className='' data-aos="fade-up"
                ...
                <div className='p-8 space-y-4'>
                    ...
                    <p className='text-white lg:text-xl '>
                        I'm  <span className='text-yellow-500 '> <a href=""> Mahbubur Rahman Mahbub</a> </span> , From Sylhet , Bangladesh. I'm currently doing  <span className='text-yellow-500 '> <a href=""> Computer science and Engineering</a> </span>  from  <span className='text-yellow-500 hover:underline'> <a href="https://www.lus.ac.bd">Leading University </a> </span> Kamalbazar , Sylhet.  I am  web developer who is passionate about building stunning and useful web applications. With a strong background in programming , I completed 130 Problems from Codeforce, and a dedication to lifelong learning, I am well-positioned to have a big influence in the web development industry.  I have one and half year   frontend development and half year back end development .Moreover, I have
                        good communication skill. Moreover, I have good
