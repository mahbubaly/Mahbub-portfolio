            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 justify-center p-6 gap-8 items-center mt-10'>
                <div className='space-y-4 text-yellow-600'>
                    ...
                    <div className='gap-6 flex'>
                        ...
                        <button className='btn btn-outline  hover:border-none text-white hover:bg-yellow-700 duration-700 '><a href={resume} download>Download Resume</a></button>

                    </div>
                </div>
                <img className=' lg:ml-[28%] w-[400px] h-[400px] justify-center rounded-[50%]' src={img} alt="" />
            </div>
        </>
    );
};
